...
- Kimi Code CLI 2.0.1, the recommended version for plugin 2.0.3
...
- Node.js 22.5 或更高版本
- Kimi Code CLI 2.0.1，这是插件 2.0.3 的推荐版本
...
- Kimi Code CLI 2.0.1, la version recommandée pour le plugin 2.0.3
...
- Node.js 22.5 以降
- Kimi Code CLI 2.0.1（プラグイン 2.0.3 の推奨バージョン）
