...
- Kimi Code CLI 2.0.2, the recommended version for plugin 2.0.4
...
- Node.js 22.5 或更高版本
- Kimi Code CLI 2.0.2，这是插件 2.0.4 的推荐版本
...
- Kimi Code CLI 2.0.2, la version recommandée pour le plugin 2.0.4
...
- Node.js 22.5 以降
- Kimi Code CLI 2.0.2（プラグイン 2.0.4 の推奨バージョン）
