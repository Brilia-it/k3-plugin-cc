...
In Claude Code, run `/kimi:setup --models`. In Codex, ask `$kimi-setup` to list
...
```text
/kimi:review -m 'my-provider/my-model' review this diff
/kimi:ask -m 'my-provider/my-model' explain the cache
```
