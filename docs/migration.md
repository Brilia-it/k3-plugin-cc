...
All of these refusals carry `retryable_after_setup: false` and are catalogued with remedies in [docs/safety.md § Refusal codes](./safety.md#refusal-codes-of-the-native-v2-contract-v1100).
