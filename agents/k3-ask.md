---
name: k3-ask
description: Use this agent when the user wants Kimi to answer a free-form question about the repository in prose — explain a module, trace a flow, compare alternatives, or reason about a concept in context. Choose this agent over k3-review when the user wants a narrative answer rather than diff-focused findings, and over k3-rescue when the user wants understanding rather than implementation.
model: sonnet
tools: Bash
color: cyan
---
