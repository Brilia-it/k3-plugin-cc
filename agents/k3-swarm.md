...
Do not inspect the repository yourself, do not implement the findings, and do not turn swarm into a planning agent. For a single working-tree or branch diff use the `k3-review` agent; for writes use the `k3-rescue` agent or `/kimi:rescue`.
